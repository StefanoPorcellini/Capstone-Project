...
{
    /// <inheritdoc />
    public partial class new_initDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RagioneSociale = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsLaserCustom = table.Column<bool>(type: "bit", nullable: true),
                    LaserStandardId = table.Column<int>(type: "int", nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: true),
                    IsPlotterCustom = table.Column<bool>(type: "bit", nullable: true),
                    ...
                    PlotterItem_Quantity = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
